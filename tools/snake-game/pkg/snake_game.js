...
export class SnakeGame {
     ...
     */
    get_score() {
        const ret = wasm.snakegame_get_score(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {string} key
    ...
    handle_key(key) {
        ...
        wasm.snakegame_handle_key(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {boolean}
     */
    is_game_over() {
        const ret = wasm.snakegame_is_game_over(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_paused() {
        const ret = wasm.snakegame_is_paused(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    constructor(canvas) {
        const ret = wasm.snakegame_new(canvas);
        if (ret[2]) {
    ...
    restart() {
        wasm.snakegame_restart(this.__wbg_ptr);
    }
    update() {
